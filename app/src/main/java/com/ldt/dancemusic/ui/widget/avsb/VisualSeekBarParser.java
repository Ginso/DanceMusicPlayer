package com.ldt.dancemusic.ui.widget.avsb;

import androidx.annotation.NonNull;
import androidx.annotation.WorkerThread;

import com.ldt.dancemusic.interactors.AppExecutors;
...
class VisualSeekBarParser implements ProgressListener {
    ...
    protected com.ldt.dancemusic.ui.widget.soundfile.SoundFile mSoundFile;
    ...
    void parse(Song song) {
        AppExecutors.getInstance().networkIO().execute(() -> {
                    ...
                    try {
                        mSoundFile = com.ldt.dancemusic.ui.widget.soundfile.SoundFile.create(song, this);
                        //Thread.sleep(2500);
